                ...
                column.Item().Column(productsSection =>
                {
                    ...
                    productsSection.Item().Background(Colors.Grey.Lighten3).Padding(10).Table(table =>
                    {
                        ...
                        foreach (var product in _workday.Cinema.Products)
                        {
                            ...
                            table.Cell().Element(CellStyle).AlignCenter().Text(product.Amount.ToString());
                            table.Cell().Element(CellStyle).AlignCenter().Text(product.IncomeAmount.ToString());
                            table.Cell().Element(CellStyle).AlignCenter().Text(product.SoldAmount.ToString());
                            table.Cell().Element(CellStyle).AlignCenter().Text($"{product.Price}$");
